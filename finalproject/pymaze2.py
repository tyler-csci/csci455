...
#b = Button(app, text="Let's Try this route", width=10, command= )
...
#exit = Button(app, text = "Exit"), width = 10, command = exit())

label.grid()
#b.grid(side="bottom",padx=0,pady=0)
...
button_east.grid(row = 3, column = 2)
button_east.grid(padx = 2, pady = 2)
button_west.grid(row = 1, column = 3)
